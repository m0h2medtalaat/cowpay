...
abstract class RemoteDataSource {
  Future<FawryResponseModel> fawryCharge({required FawryRequestModel fawryRequestModel});
  Future<CreditCardResponseModel> creditCardCharge({required CreditCardRequestModel creditCardRequestModel});
  Future<CashCollectionResponseModel> cashCollectionCharge({required CashCollectionRequestModel cashCollectionRequestModel});
}
...
class RemoteDataSourceImpl implements RemoteDataSource{
  ...
  //region Fawry
  Future<FawryResponseModel> _fawryChargeCall(FawryRequestModel fawryRequestModel) async {
    try {
