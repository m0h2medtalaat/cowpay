...
class RepositoryImpl implements Repository{
  ...
  @override
  Future<Either<Failure, FawryResponseModel>> fawryCharge({required FawryRequestModel fawryRequestModel}) async {
     try {
       final fawryResponseModel = await remoteDataSource.fawryCharge(fawryRequestModel: fawryRequestModel);
  ...
  @override
  Future<Either<Failure, CashCollectionResponseModel>> cashCollectionCharge({required CashCollectionRequestModel cashCollectionRequestModel}) async{
    try {
      final cashCollectionResponseModel = await remoteDataSource.cashCollectionCharge(cashCollectionRequestModel: cashCollectionRequestModel);
  ...
  @override
  Future<Either<Failure, CreditCardResponseModel>> creditCardCharge({required CreditCardRequestModel creditCardRequestModel}) async{
    try {
      final creditCardResponseModel = await remoteDataSource.creditCardCharge(creditCardRequestModel: creditCardRequestModel);
